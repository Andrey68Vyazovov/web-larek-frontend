...
2. Page и Modal - потомки класса Component. 
  2.1 Page является контейнером для галереи товаров и счетчика товаров в корзине.
Содержит сеттеры:
  ...
  2.2 Modal - контейнер для форм ввода данных о доставке и контактах пользователя.
Содержит сеттер:
...
3. Классы Card, Basket, Form, Delivery, Contacts и Confirm - потомки класса Component. Предназначены для визуализации компонент приложения, таких как: карточка товара, корзина, форма и подтверждения выполнения оплаты заказа.
  3.1 Card - класс для визуального представления карточки товара.
  Содержит сеттеры для установки id, наименования, изображения, категории и цены товара, установки кнопки добавления вкорзину.
  А также геттеры для получения id, наименования и цены товара.
  3.2 Basket - класс представления для корзины товаров.
  Содержит следующие сеттеры для установки кол-ва товаров в корзине и заполнения корзины элементами карточек товара.
  3.3 Form<T> - базовый класс для Delivery и Contacts. Предназначен для визуализации элементов управления формами, а также отвечает за валидацию полей форм.
  ...
  Сеттеры: 'set valid' - установка состояния кнопки на основании данных валидации полей формы.
  'set errors' - установка текста для элемента отображающего ошибки валидации полей формы.
  3.4 Delivery - класс визуализации формы ввода данных о доставке.
  Содержит метод: 'setClass' - упраление состоянием кнопок выбора способа платежа.
  3.5 Contacts - класс визуализации формы ввода контактов пользователя.
  3.6 Confirm - класс для вывода информации об успешном оформлении заказа.
